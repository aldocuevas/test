...
public class FrmDiarioCreditos
    extends JFrame {
...
FrmDatosVenta frmDatosVenta = null;
  ...
  private void jbInit() throws Exception {
    ...
    lblTotalBoutiqueLocal.setText("jLabel6");
    ...
    lblTotalBoutique2.setText("jLabel6");
    ...
    lblFechaHoy.setFont(new java.awt.Font("Dialog", Font.BOLD, 16));
    lblFechaHoy.setText("jLabel6");
  ...
  public void this_windowOpened(WindowEvent e) {
    ...
    this.lblFechaHoy.setText(AppInstance.formatoCorto.format(new java.util.Date()));
...
class FrmDiarioCreditos_tblBoutique2_mouseAdapter
    extends MouseAdapter {
  private FrmDiarioCreditos adaptee;
  FrmDiarioCreditos_tblBoutique2_mouseAdapter(FrmDiarioCreditos adaptee) {
...
class FrmDiarioCreditos_tblBoutique1_mouseAdapter
    extends MouseAdapter {
  private FrmDiarioCreditos adaptee;
  FrmDiarioCreditos_tblBoutique1_mouseAdapter(FrmDiarioCreditos adaptee) {
    this.adaptee = adaptee;
  }
...
class FrmDiarioCreditos_tblBoutiqueLocal_mouseAdapter
    extends MouseAdapter {
  private FrmDiarioCreditos adaptee;
  FrmDiarioCreditos_tblBoutiqueLocal_mouseAdapter(FrmDiarioCreditos adaptee) {
    this.adaptee = adaptee;
  }
...
class FrmDiarioCreditos_cmdCerrar_actionAdapter
    implements ActionListener {
  private FrmDiarioCreditos adaptee;
  FrmDiarioCreditos_cmdCerrar_actionAdapter(FrmDiarioCreditos adaptee) {
    this.adaptee = adaptee;
  }
...
class FrmDiarioCreditos_this_windowAdapter
    extends WindowAdapter {
  private FrmDiarioCreditos adaptee;
  FrmDiarioCreditos_this_windowAdapter(FrmDiarioCreditos adaptee) {
    this.adaptee = adaptee;
  }
