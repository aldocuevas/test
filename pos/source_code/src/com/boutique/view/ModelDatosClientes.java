...
public class ModelDatosClientes extends AbstractTableModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5703836885026115826L;

	private boolean DEBUG = false;

	private String[] columnNames = { "Id", "Nombre", "Domicilio", "Colonia",
			"Ciudad", "Telefono", "Tipo", "Status" };

	// public Object[][] data = new Object[0][0];
	public List<Object[]> data = new ArrayList<Object[]>();
	Object[] row;

	public ModelDatosClientes() {
		try {
			jbInit();
		} catch (Exception ex) {
			ex.printStackTrace();
	...
	public void setClientes(List<Object[]> v) {
		this.data = v;
		this.fireTableDataChanged();
