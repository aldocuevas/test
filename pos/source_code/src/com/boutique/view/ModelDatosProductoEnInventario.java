...
public class ModelDatosProductoEnInventario extends AbstractTableModel {
	/**
	 * 
	 */
	...
	private String[] columnNames = { "id", "Cantidad", "Producto", "Detalle",
			"Etiqueta", "Fecha de compra", "P.U.", "Total" };

	public List<Object[]> data = new ArrayList<Object[]>();
	Object[] renglon;

	public ModelDatosProductoEnInventario() {
		try {
			jbInit();
		} catch (Exception ex) {
			ex.printStackTrace();
