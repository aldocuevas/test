...
public class ModelDatosProductoVendido extends AbstractTableModel {
	/**
	 * 
	 */
	...
	private String[] columnNames = { "id", "Fecha", "No. de venta", "Etiqueta",
			"Precio" };

	public Vector<Object[]> data = new Vector<Object[]>();
	Object[] renglon;

	public ModelDatosProductoVendido() {
		try {
			jbInit();
		} catch (Exception ex) {
			ex.printStackTrace();
