...
public class PnlVentaCreditoFechaDefinida extends JPanel {
	/**
	 * 
	 */
	...
	com.toedter.calendar.JDateChooser jcFechaVenta = new JDateChooser();
	...
	public PnlVentaCreditoFechaDefinida() {
		try {
			jbInit();
		} catch (Exception ex) {
			ex.printStackTrace();
	...
	void jbInit() throws Exception {
		...
		txtNumero.setBorder(BorderFactory.createEtchedBorder());
		...
		tblProductos
				.addKeyListener(new PnlPuntoVentaCreditoVentaDefinida_tblProductos_keyAdapter(
						this));
		...
		txtEtiqueta.setText("");
		txtEtiqueta
				.addActionListener(new PnlPuntoVentaVentaDefinida_txtEtiqueta_actionAdapter(
						this));
		...
		cmdRegistrarSinRecibir
				.addActionListener(new PnlPuntoVentaCreditoVentaDefinida_cmdRegistrarSinRecibir_actionAdapter(
						this));
		...
		cmdAgregarProducto
				.addActionListener(new PnlPuntoVentaCreditoVentaDefinida_cmdAgregarProducto_actionAdapter(
						this));
		...
		rSemanal.addActionListener(new PnlPuntoVentaCreditoVentaDefinida_rSemanal_actionAdapter(
				this));
		rQuincenal.setSelected(true);
		rQuincenal.setText("Quincenal");
		rQuincenal
				.addActionListener(new PnlPuntoVentaCreditoVentaDefinida_rQuincenal_actionAdapter(
						this));
		...
		rMensual.addActionListener(new PnlPuntoVentaCreditoVentaDefinida_rMensual_actionAdapter(
				this));
		...
		cmbCantidadPagos
				.addItemListener(new PnlPuntoVentaCreditoVentaDefinida_cmbCantidadPagos_itemAdapter(
						this));
		...
		cmdPonerAnticipo
				.addActionListener(new PnlPuntoVentaCreditoVentaDefinida_cmdPonerAnticipo_actionAdapter(
						this));
		cmdRegistrarVenta.setEnabled(false);
		cmdRegistrarVenta.setFont(new java.awt.Font("Dialog", Font.PLAIN, 11));
		cmdRegistrarVenta.setMnemonic('R');
		cmdRegistrarVenta.setText("REGISTRAR VENTA");
		cmdRegistrarVenta
				.addActionListener(new PnlPuntoVentaCreditoVentaDefinida_cmdRegistrarVenta_actionAdapter(
						this));
		...
		cmdImprimirNota.setText("IMPRIMIR NOTA");
		cmdImprimirNota
				.addActionListener(new PnlVentaCreditoVentaDefinida_cmdImprimirNota_actionAdapter(
						this));
		cmdCerrar.setEnabled(true);
		cmdCerrar.setFont(new java.awt.Font("Dialog", Font.PLAIN, 11));
		cmdCerrar.setText("CERRAR");
		cmdCerrar
				.addActionListener(new PnlVentaCreditoVentaDefinida_cmdCerrar_actionAdapter(
						this));
		...
		jcFechaVenta
				...
				.getUiComponent()
				.addMouseListener(
						new PnlVentaCreditoFechaDefinida_jcFechaVenta_mouseAdapter(
								this));
		...
		pnlDatosClienteyBusquedaArticulo.add(pnlBusquedaClientes,
				BorderLayout.NORTH);
		pnlBusquedaClientes.add(pnlLeftBuscarCliente, BorderLayout.EAST);
		...
		jcFechaVenta.setMinimumSize(new java.awt.Dimension(200, 20));
		jcFechaVenta.setPreferredSize(new java.awt.Dimension(200, 20));
		pnlBusquedaClientes.add(jcFechaVenta, BorderLayout.WEST);
		...
		pnlBusquedaArticulos
				.add(cmdAgregarProducto, java.awt.BorderLayout.EAST);
		...
		jcFechaVenta.setDate(com.boutique.dao.DaoSource.getFechaActual());
	...
	public void setDatosCliente() {
		...
		this.txtNumero.setText(engine.cliente().getNumero());
	...
	private void setPagos() {
		...
		if (rSemanal.isSelected()) {
			...
			engine.calcularFechasDePago(7, noPagos, jcFechaVenta.getDate());
			this.modelPagosCredito1.fireTableDataChanged();
		} else if (rQuincenal.isSelected()) {
			engine.calcularFechasDePago(15, noPagos, jcFechaVenta.getDate());
			this.modelPagosCredito1.fireTableDataChanged();
		}

		else if (rMensual.isSelected()) {
			engine.calcularFechasDePago(30, noPagos, jcFechaVenta.getDate());
			this.modelPagosCredito1.fireTableDataChanged();
		}
	...
	public void cmdRegistrarVenta_actionPerformed(ActionEvent e) {
		if (cmdRegistrarVenta.isEnabled()) {
			...
			this.engine.fecha.setTime(jcFechaVenta.getDate().getTime());
			if (this.engine.registrarVentaFechaAnterior()) { // Damos de alta la
																// venta

				// engine.imprimirNota(this.modelPagosCredito1.data);
				// //Imprimimos la nota de venta de credito
	...
	public void jcFechaVenta_actionPerformed(ActionEvent e) {
		JOptionPane.showMessageDialog(this.getRootPane(), "hola");
	}

	public void jcFechaVenta_mouseClicked(MouseEvent e) {
		JOptionPane.showMessageDialog(this, "asdfasdf", "asdf",
				JOptionPane.DEFAULT_OPTION);
	}

}

class PnlVentaCreditoFechaDefinida_jcFechaVenta_mouseAdapter extends
		MouseAdapter {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlVentaCreditoFechaDefinida_jcFechaVenta_mouseAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}

	public void mouseClicked(MouseEvent e) {
		adaptee.jcFechaVenta_mouseClicked(e);
	}
}

class PnlVentaCreditoVentaDefinida_cmdCerrar_actionAdapter implements
		ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlVentaCreditoVentaDefinida_cmdCerrar_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlVentaCreditoVentaDefinida_cmdImprimirNota_actionAdapter implements
		ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlVentaCreditoVentaDefinida_cmdImprimirNota_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_cmdRegistrarVenta_actionAdapter
		implements ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_cmdRegistrarVenta_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_cmdRegistrarSinRecibir_actionAdapter
		implements ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_cmdRegistrarSinRecibir_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_cmdPonerAnticipo_actionAdapter
		implements ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_cmdPonerAnticipo_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_tblProductos_keyAdapter extends
		KeyAdapter {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_tblProductos_keyAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_cmbCantidadPagos_itemAdapter implements
		ItemListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_cmbCantidadPagos_itemAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_cmdAgregarProducto_actionAdapter
		implements ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_cmdAgregarProducto_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_rMensual_actionAdapter implements
		ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_rMensual_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_rQuincenal_actionAdapter implements
		ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_rQuincenal_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaCreditoVentaDefinida_rSemanal_actionAdapter implements
		ActionListener {
	private PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaCreditoVentaDefinida_rSemanal_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
...
class PnlPuntoVentaVentaDefinida_txtEtiqueta_actionAdapter implements
		java.awt.event.ActionListener {
	PnlVentaCreditoFechaDefinida adaptee;

	PnlPuntoVentaVentaDefinida_txtEtiqueta_actionAdapter(
			PnlVentaCreditoFechaDefinida adaptee) {
		this.adaptee = adaptee;
	}
